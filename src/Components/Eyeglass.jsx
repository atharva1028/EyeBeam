...
export default function Eyeglass() {
    const handleImageClick = (index) => {
        localStorage.setItem('clickedImageIndex', cardData[0].images[index]);
      };
  return (
    <>
    ...
    <div className='container-fluid pt-2 pb-2'>
      <Swiper navigation={true}
        ...
        <div className="card" style={{border: 'none'}}>
            ...
            <img src={cardData[0].images[0]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[0].images[1]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[0].images[2]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[0].images[3]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[0].images[4]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[0].images[5]} alt="" />
