...
export default function Progressive() {
    const handleImageClick = (index) => {
        localStorage.setItem('clickedImageIndex', cardData[2].images[index]);
      };
  return (
    <>
    <div className='d-flex justify-content-center pt-5 pb-5'>
            <h3>PROGRESSIVE GLASSES</h3>
    </div>
    <div className='container-fluid pt-2 pb-2'>
      <Swiper navigation={true}
        ...
        <div className="card" style={{border: 'none'}}>
            ...
            <img src={cardData[2].images[0]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[2].images[1]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[2].images[2]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[2].images[3]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[2].images[4]} alt="" />
        ...
        <div className="card" style={{border: 'none'}}>
            <div className="card-body">
            <img src={cardData[2].images[5]} alt="" />
